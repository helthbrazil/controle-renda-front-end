...
@Component({
  selector: 'renda-grafico-tipo',
  templateUrl: './grafico-tipo.component.html',
  styleUrls: ['./grafico-tipo.component.css']
})
export class GraficoTipoComponent implements OnInit {
